...
{
    /*Calculate the current step*/
    uint32_t t = lvMap(a->act_time, 0, a->duration, 0, LV_BEZIER_VAL_MAX);
    int32_t step = lvBezier3(t, 0, 50, 100, LV_BEZIER_VAL_MAX);
...
int32_t lvAnimPathEaseOut(const LVAnimInner_t *a)
{
    /*Calculate the current step*/
    uint32_t t = lvMap(a->act_time, 0, a->duration, 0, LV_BEZIER_VAL_MAX);
    int32_t step = lvBezier3(t, 0, 900, 950, LV_BEZIER_VAL_MAX);
...
int32_t lvAnimPathEaseInOut(const LVAnimInner_t *a)
{
    /*Calculate the current step*/
    uint32_t t = lvMap(a->act_time, 0, a->duration, 0, LV_BEZIER_VAL_MAX);
    int32_t step = lvBezier3(t, 0, 50, 952, LV_BEZIER_VAL_MAX);
...
int32_t lvAnimPathOvershoot(const LVAnimInner_t *a)
{
    /*Calculate the current step*/
    uint32_t t = lvMap(a->act_time, 0, a->duration, 0, LV_BEZIER_VAL_MAX);
    int32_t step = lvBezier3(t, 0, 1000, 1300, LV_BEZIER_VAL_MAX);
...
{
    /*Calculate the current step*/
    int32_t t = lvMap(a->act_time, 0, a->duration, 0, LV_BEZIER_VAL_MAX);
    ...
    int32_t step = lvBezier3(t, LV_BEZIER_VAL_MAX, 800, 500, 0);
